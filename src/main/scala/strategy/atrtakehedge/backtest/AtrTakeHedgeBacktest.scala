package strategy.atrtakehedge.backtest
...
import strategy.atrtakehedge.logic.AtrTakeHedgeStrategy
...
/** 买方 (long-gamma) ATR 通道 take 式对冲回测 ([[AtrTakeHedgeStrategy]])。
  ...
  *
  * 运行: sbt "runMain strategy.atrtakehedge.backtest.AtrTakeHedgeBacktest [START] [END] [IV] [atrMult] [straddles]"
  */
