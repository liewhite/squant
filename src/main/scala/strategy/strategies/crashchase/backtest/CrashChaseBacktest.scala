package strategy.strategies.crashchase.backtest
...
import strategy.strategies.crashchase.logic.CrashChaseStrategy
...
/** 追暴跌做空策略回测入口 ([[CrashChaseStrategy]])。
  ...
  *
  * 运行: sbt "runMain strategy.strategies.crashchase.backtest.CrashChaseBacktest [SYMBOL] [START yyyy-MM-dd] [END yyyy-MM-dd]"
  * 例:   sbt "runMain strategy.strategies.crashchase.backtest.CrashChaseBacktest SIRENUSDT 2026-06-04 2026-06-14"
  */
