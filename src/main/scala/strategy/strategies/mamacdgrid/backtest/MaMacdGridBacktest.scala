package strategy.strategies.mamacdgrid.backtest
...
/** 均线 + MACD 方向性网格策略回测 —— 止盈方案对比 (基线 / 方案1 / 方案2)。
  ...
  *
  * 运行:
  *   sbt "runMain strategy.strategies.mamacdgrid.backtest.MaMacdGridBacktest [SYMBOL] [START] [END] [baseQty] [maxPos] [atrN]"
  * 例:
  *   sbt "runMain strategy.strategies.mamacdgrid.backtest.MaMacdGridBacktest ETHUSDT 2025-04-10 2026-06-15 5 100 3.0"
  */
