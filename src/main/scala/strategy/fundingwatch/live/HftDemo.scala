package strategy.fundingwatch.live
...
import strategy.fundingwatch.logic.FundingWatchStrategy
...
/** HFT 框架演示入口。
  ...
  *
  * 运行: sbt "runMain strategy.fundingwatch.live.HftDemo [conf/demo-binance.json]"
  */
