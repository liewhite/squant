package strategy.bbomaker.backtest
...
/** 回测入口：用币安官方历史 bookTicker + trades 还原行情，对策略做确定性回测。
  ...
  *
  * 运行: sbt "runMain strategy.bbomaker.backtest.BacktestDemo [SYMBOL] [START yyyy-MM-dd] [END yyyy-MM-dd]"
  * 例:   sbt "runMain strategy.bbomaker.backtest.BacktestDemo BTCUSDT 2024-01-01 2024-01-01"
  */
