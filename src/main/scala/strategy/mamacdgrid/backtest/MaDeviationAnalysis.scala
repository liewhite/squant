...
/** 历史"价偏离均线 / ATR"分布分析 —— 为 [[strategy.mamacdgrid.logic.MaMacdGridStrategy]] 方案2 标定阈值 N。
  *
  ...
  *
  * 运行: sbt "runMain strategy.mamacdgrid.backtest.MaDeviationAnalysis [SYMBOL] [START] [END]"
  */
